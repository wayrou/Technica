...
const EDITOR_STORAGE_KEYS: Record<DatabaseContentType, string> = {
  ...
  chatter: "technica.chatter.document",
  quest: "technica.quest.document",
  key_item: "technica.keyItem.document",
  faction: "technica.faction.document",
  chassis: "technica.chassis.document",
  doctrine: "technica.doctrine.document",
